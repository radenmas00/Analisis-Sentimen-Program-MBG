# -*- coding: utf-8 -*-
"""Copy of Final LSTM MBG.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1TPaRtGIedwpflWBn--KpOwN4DzgZbTB8
...
data = pd.read_csv('/content/drive/MyDrive/Skripsi_Dimas Aryo Wibowo_21.11.3972/Dataset/twitter/X/x_mbg3.csv')
...
df = pd.read_csv('/content/drive/MyDrive/Skripsi_Dimas Aryo Wibowo_21.11.3972/Dataset/stemmed_dataset.csv')
...
df.to_csv('labelingdatasetx2.csv', index=False)
...
colors = sns.color_palette("coolwarm_r", n_colors=2)[::-1]
...
plt.axvline(x=60, color='red', linestyle='--', linewidth=1.5, label='max_len = 60')
...
plt.axvline(x=60, color='purple', linestyle='--', linewidth=1.5, label='max token = 60')
...
df = pd.read_csv('/content/drive/MyDrive/Skripsi_Dimas Aryo Wibowo_21.11.3972/Dataset/labelingdatasetx2.csv')
...
x_train_pad = pad_sequences(x_train_seq, maxlen=60)
x_test_pad = pad_sequences(x_test_seq, maxlen=60)
...
with open('tokenizerx.pkl', 'wb') as file:
...
# LSTM
lstm = LSTM(128, return_sequences=False)(embedding)  # Tidak mengembalikan urutan karena pooling langsung
